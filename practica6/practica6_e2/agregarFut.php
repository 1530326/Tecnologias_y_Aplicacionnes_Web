<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $res = agregar($id,$nombre,$posicion,$carrera,$email,"futbolistas"); //mandar los valores a la funcion de agregar que se encuentra en el archivo funciones.php

    if($res){ 
      header('Location: main_fut.php'); //si se agregó con éxito redireccionar al main_fut
    } else{
