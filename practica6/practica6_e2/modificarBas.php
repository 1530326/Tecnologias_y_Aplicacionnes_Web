<?php
  ...
  $user = detallesModificar($id,"basquetbolistas"); //ejecutar la función que trae como resultado los datos del usuario de la tabla correspondiente
  ...
  if(isset($_POST['submit'])){
    ...
    $res = modificar($id, $uNombre, $uPosicion, $uCarrera, $uEmail, "basquetbolistas"); //mandar los valores a la funcion de modificar que se encuentra en el archivo funciones.php

    if($res){ 
      header('Location: main_bas.php'); //si se modificó con éxito redireccionar a main_fut.php
    } else{
