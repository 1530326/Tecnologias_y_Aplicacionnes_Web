...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="views/tools/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../tools/index2.html"><b>INVENTA</b>RIO</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form method="post">
      ...
      <div aclass="row">
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" name="iniciar" class="btn btn-primary btn-block btn-flat">Iniciar sesión</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- iCheck -->
<script src="views/tools/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
