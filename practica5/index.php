<?php
  ...
  $user = mostrar(); //ejecutar la funcion que trae todos los registros de la tabla usuarios
  $total_users = count(mostrar()); //cuenta el total de registros devuelto por la consulta
?>
<!doctype html>
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="large-9 columns">
        <h3>Usuarios</h3>
          <p><a href="agregarUsuario.php" class="button radius tiny secondary">Agregar nuevo</a></p>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="./modificar.php?id=<?php echo $users[0]; ?>" class="button radius tiny secondary">Modificar</a>
    ...
    <script type="text/javascript">
      function confirmar(id){
        ...
        if(r){
           window.location.href='eliminar.php?id='+id; //se redirecciona al archivo de eliminar.php
        }else{
